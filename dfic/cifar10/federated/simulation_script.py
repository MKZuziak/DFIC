...
def simulation():
    ...
    dataset_path = r'/home/maciejzuziak/raid/DL_course/DFIC/dfic/fmnist/federated/dataset/FMNIST_10_dataset_pointers'
    with open(dataset_path, 'rb') as file:
        data = pickle.load(file)
    orchestrator_data = data[0]
    nodes_data = data[1]
    net_architecture = timm.create_model('resnet18', num_classes=10, in_chans=1, pretrained=False)
    optimizer_architecture = partial(optim.Adam, lr=0.001)
